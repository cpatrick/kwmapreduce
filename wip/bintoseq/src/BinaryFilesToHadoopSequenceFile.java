/** licensing:  I can't find licensing info for this, it was posted 
    online in a public forum and described in a blog post. -mjg
*/
...
public class BinaryFilesToHadoopSequenceFile {
	...
	public static class BinaryFilesToHadoopSequenceFileMapper extends Mapper<Object, Text, Text, BytesWritable> {
		...
		throws IOException, InterruptedException {
                        ...
                        Text filename = new Text(value.toString().substring(value.toString().lastIndexOf('/')+1));
			...
			try {
				...
				context.write(filename, new BytesWritable(bout.toByteArray()));
			} finally {
